					...
					<div id="store" class="col-md-9">
						...
						<div class="row">
							...
							include('koneksi.php');
												...
												$query = mysql_query("SELECT * FROM jasa ORDER BY id_jasa DESC") or die(mysql_error());
							...
							<!-- product -->
										<div class='product'>
											<div class='product-img'>
											<h3 class='product-name'><a href=''>&nbsp;</a></h3>
												<center><img src='img/".$data['gambar_jasa']."' alt='' style='height: 200px; width: 60%;'></center>
											...
											<div class='product-body'>
												...
												<h3 class='product-name'><a href=''>".$data['nama_jasa']."</a></h3>
