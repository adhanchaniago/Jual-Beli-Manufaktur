    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">Form Jasa</a>
            </div>
            <!-- /.navbar-header -->
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Form Jasa</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Masukkan Data Jasa Baru
                        </div>
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form action="proses_jasa.php" method="POST" role="form">
                                        <div class="form-group">
                                            
                                            <input type="hidden" name="id_jasa">

                                            <label>Nama Jasa :</label>
                                            <input name="nama_jasa" class="form-control">
                                            <p class="help-block"></p>
                                        </div>

                                        <div class="form-group">
                                            <label>Masukkan Gambar</label>
                                            <input name="gambar_jasa" type="file">
                                        </div>

                                        <div class="form-group">
                                            <label>Keterangan :</label>
                                            <input name="keterangan" class="form-control" size="10">
                                            <p class="help-block"></p>
                                        </div>

                                        <div class="form-group">
                                            <label>Harga :</label>
                                            <input name="harga" class="form-control" size="10">
                                            <p class="help-block"></p>
                                        </div>
                                        ...
                                        &nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;
                                        <button type="submit" name="tambah" class="btn btn-default">Proses</button>
                                        &nbsp; &nbsp;
