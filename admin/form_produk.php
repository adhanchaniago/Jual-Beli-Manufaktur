                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form action="proses_produk.php" method="POST" role="form">
                                        <div class="form-group">
                                            
                                            <input type="hidden" name="id_produk">

                                            <label>Nama Produk :</label>
                                            <input name="nama_produk" class="form-control">
                                        ...
                                        <div class="form-group">
                                            <label>Warna :</label>
                                            <input name="warna" class="form-control" size="10">
                                            <p class="help-block"></p>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label>Stok :</label>
                                            <input name="stok" type="number" class="form-control" size="10">
                                            <p class="help-block"></p>
                                        </div>
