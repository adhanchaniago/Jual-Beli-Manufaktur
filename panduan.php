					...
					<div class="col-md-7">
						...
						<div class="billing-details">
							<div class="section-title">
								<h3 class="title">Panduan Belanja</h3>
							</div>
							...
							<div class="form-group">
								2. Lalu klik "Add to Cart"
							</div>

							<div class="form-group">
								3. Klik gambar keranjang pada bagian kanan atas website
							</div>

							<div class="form-group">
								4. Pastikan produk yang dipesan benar lalu klik "Checkout"
							</div>

							<div class="form-group">
								5. Opsional : <br><br>
								&nbsp;&nbsp;&nbsp;&nbsp;<b>- Jika sudah login sebagai member : </b><br>
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Buat catatan transaki pada menu "Catatan" (jika diperlukan) lalu klik "Proses". <br><br>
								&nbsp;&nbsp;&nbsp;&nbsp;<b>- Jika belum terdaftar sebagai member :</b><br>
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Lengkapi data diri anda dan buat catatan transaki pada menu "Catatan" (jika diperlukan) &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;lalu klik proses. 
							</div>
						...
						<div class="col-md-3 col-xs-6">
							<div class="footer">
								...
								<ul class="footer-links">
									<li><a href="#"><i class="fa fa-map-marker"></i>East Jakarta</a></li>
									<li><a href="#"><i class="fa fa-phone"></i>+62 812 1105 3115</a></li>
