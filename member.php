	...
	<body>
		...
		<div id="breadcrumb" class="section">
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-md-12">
						<h3 class="breadcrumb-header">REGISTER MEMBER</h3>
				...
				<div class="row">
					...
					<div class="col-md-7">
						...
						<div class="billing-details">
							...
							<form action="regismember.php" method="POST">
							...
							<div class="form-group">
									...
									<div class="form-group">
										<input class="input" type="text" name="telepon" placeholder="Telepon">
									</div>
									...
									<input type="submit" value=" Submit" class="primary-btn order-submit">
							</form>
