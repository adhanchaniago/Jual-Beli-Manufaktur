						...
						<div class="section-title">
							...
							<div class="section-nav">
								<ul class="section-tab-nav tab-nav">
									<li class="active"><a data-toggle="tab" href="#tab1">Rib Manufacture</a></li>
									...
									<div class="products-slick" data-nav="#slick-nav-1">
										<!-- product -->
											...
											<?php
												...
												$query = mysql_query("SELECT * FROM testimoni ORDER BY id_testimoni ASC") or die(mysql_error());
										...
										<div class='product'>
											<div class='product-img'>
												<img src='img/".$data['gambar_tes']."' alt='' style='height: 300px; width: 100%;'>
												<div class='product-label'>
													<span class='new'>".$data['perusahaan']."</span>
												</div>
											</div>
											<div class='product-body'>
												<p class='product-category'>".$data['pekerjaan']."</p>
												<h4 class='product-price'>".$data['nama_tes']." <del class='product-old-price'></del></h4>
												<h3 class='product-name'><a href=''><quote>".$data['testimonial']."</a></h3>
